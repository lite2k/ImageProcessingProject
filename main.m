...
%orig_im = imread('.\TestCases\Bounses\Case4\Case 4-1.jpg');
%orig_im = imread('.\TestCases\Bounses\Case4\Case 4-2.jpg');
%orig_im = imread('.\TestCases\Bounses\Case4\Case 4-3.jpg');
%orig_im = imread('.\TestCases\Bounses\Case5\1.jpg');
%orig_im = imread('.\TestCases\Bounses\Case5\7.jpg');
%orig_im = imread('.\TestCases\Bounses\Case5\8.jpg');
%orig_im = imread('.\TestCases\Bounses\Case5\9.jpg');
%orig_im = imread('.\TestCases\Bounses\Case5\10.jpg');
